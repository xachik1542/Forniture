...
function Inform() {
  return (
    <div className={styles.container_block}>
      <div className={styles.container_using_box}>
      ...
      <div className={styles.container_personal_box}>
      ...
      <div className={styles.container_servis_one}>
      ...
      <div className={styles.container_servis_two}>
